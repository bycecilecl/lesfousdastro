    ...
    try:
        ...
        try:
            ...
            if dest_email and pdf_final_url:
                ...
                body_txt = (
                    f"Bonjour {prenom},\n\n"
                    "Ton analyse karmique est prête.\n\n"
                ...
                body_html = (
                    ...
                    "<p>Ton analyse karmique est prête.</p>"
                    f"<p>📄 <a href=\"{pdf_final_url}\" target=\"_blank\">Télécharger mon analyse karmique</a></p>"
                    "<p>Si le lien ne s'ouvre pas, copie/colle l'URL dans ton navigateur.</p>"
                    "<p>Bonne lecture,<br>Les Fous d'Astro – By Cécile CL</p>"
                )
